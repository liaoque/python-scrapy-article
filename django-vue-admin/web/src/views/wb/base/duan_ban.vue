<template>
  <el-table :data="tableData" style="width: 100%">
    ...
    <el-table-column prop="lianxuzhangtingtianshudaybeforeyesterday" sortable sort-by="lianxuzhangtingtianshudaybeforeyesterday" label="前天连板天数">
    </el-table-column>
...
<!--
代码	名称	所属行业	所属概念	25日涨停次数	前天连板天数	涨跌幅
-->
<script>
export default {
  props: [
