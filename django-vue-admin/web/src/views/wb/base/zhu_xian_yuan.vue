<template>
  <el-table :data="tableData" style="width: 100%">
    ...
    <el-table-column prop="zhangfu10" label="10日涨跌幅" sortable sort-by="zhangfu10">
    </el-table-column>
    <el-table-column prop="zhangfu30" sortable sort-by="zhangfu30" label="30日涨跌幅">
    </el-table-column>


  </el-table>
</template>
<!--  代码	    名称	所属行业	所属概念	10日涨跌幅	30日涨跌幅
