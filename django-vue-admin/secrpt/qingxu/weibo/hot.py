...
def fetch_weibo_cardlist(params=None):
...
if __name__ == '__main__':
    ...
    # 调用函数并打印结果
    result = fetch_weibo_cardlist(params,)
    ts = [{
        'id':item['mblog']['id'],
        'user':{
        ...
        'metrics':{
          "likes":    item['mblog']['attitudes_count'],  #  点赞数
          "reposts":  item['mblog']['reposts_count']  ,  #   转发数
          "comments": item['mblog']['comments_count'], #   评论数
        },
